...
* [Описание пакетов](./README.md#Описание-пакетов)
* [API](./README.md#API)
	- [Приложение (контекст)](./README.md#Приложение-(контекст))
	- [Пользователь](./README.md#Пользователь-1)
	- [Видео](./README.md#Видео-1)
	- [Гифткарты](./README.md#Гифткарты-1)
	- [Действия пользователя](./README.md#Действия-пользователя)
---
> # PRILOGULKA
> - [X] сделано
> - [ ] не сделано
